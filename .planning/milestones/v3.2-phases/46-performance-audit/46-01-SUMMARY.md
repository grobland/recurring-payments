...
plan: 01
subsystem: infra
tags: [bundle-analyzer, webpack, next.js, performance, lucide-react, turbopack]
...
affects: [46-performance-audit-02, 46-performance-audit-03, 46-performance-audit-04]

# Tech tracking
tech-stack:
  added: ["@next/bundle-analyzer@16.1.6", "cross-env@10.1.0"]
  patterns:
    - "Bundle analyzer gated behind ANALYZE=true env var"
    - "withSentryConfig wraps withBundleAnalyzer (Sentry must be outermost)"
    - "Use --webpack flag with next build to bypass Turbopack for bundle analysis"
