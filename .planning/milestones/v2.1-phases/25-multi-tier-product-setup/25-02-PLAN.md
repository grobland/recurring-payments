...
must_haves:
  truths:
    - "User can subscribe to selected tier through checkout"
    - "Grandfathered users see savings compared to current pricing"
    - "User's tier is displayed based on their active subscription"
    - "Checkout accepts tier, billing interval, and currency selection"
  artifacts:
