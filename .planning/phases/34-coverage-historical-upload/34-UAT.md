...
expected: Click a gray (missing) cell. An upload wizard modal opens titled "Upload Statement - {source name}" showing the target month (e.g., "February 2026"). A dropzone area says "Drop PDF here or click to browse".
result: pass
