...
must_haves:
  truths:
    - "Pattern detection calculates confidence scores 0-100 based on occurrence count, interval consistency, and amount consistency"
    - "Frequency detection identifies monthly (~30 days) and yearly (~365 days) patterns with 7-day tolerance"
