...
must_haves:
  truths:
    - "User can drag-and-drop multiple PDF files at once"
    - "User sees vertical list of files with individual progress bars"
    - "User can cancel individual files or the entire batch"
  artifacts:
...
- Duplicate files have Skip/Re-import options
