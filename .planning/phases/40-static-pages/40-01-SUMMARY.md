...
plan: "01"
subsystem: ui
tags: [nextjs, react, accordion, shadcn, static-content, sidebar]

# Dependency graph
requires:
  - phase: 36-navigation-restructure
    provides: app-sidebar.tsx with supportItems array placeholder for Phase 40
...
affects: [future-static-pages, navigation, support]

# Tech tracking
tech-stack:
  added: []
  patterns:
    - "Static server component pages under (dashboard)/support/ for reference/documentation content"
    - "Hardcoded const arrays for static reference data — no DB queries for stable content"
    - "Accordion type=multiple per category group with no defaultValue for all-collapsed default"
...
patterns-established:
  - "Static reference pages: server component + hardcoded const array + DashboardHeader + max-w container"
  - "FAQ accordion: Accordion type=multiple (no defaultValue) per category heading, AccordionItem value = unique id string"

requirements-completed: [SCHEMA-01, HELP-01]
